...
func (s *ffmpegService) checkForInjectionChars(rawURL string) error {
...
func (s *ffmpegService) checkForPathTraversal(rawURL string) error {
...
func (s *ffmpegService) validateURLStructureAndProtocol(rawURL string) error {
