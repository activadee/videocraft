...
# Configure logging - only errors to stderr, everything else suppressed for clean JSON communication
logging.basicConfig(
...
def main():
    ...
    if not WHISPER_AVAILABLE:
        logger.error("Whisper not available! Please install: pip install openai-whisper torch")
        sys.exit(1)
